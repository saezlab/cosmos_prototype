...
ttop_tumour_vs_healthy <- as.data.frame(
  read_csv("results/metabolomic/final_samples/ttop_tumour_vs_healthy.csv"))
...
write_csv(metab_input_carnival, "results/metabolomic/final_samples/metab_input_carnival.csv")
write_tsv(metab_input_carnival, "results/metabolomic/final_samples/metab_input_carnival.tsv")

write_csv(signaling_input_carnival, "results/phospho/final_samples/signaling_input_carnival.csv")
write_tsv(signaling_input_carnival, "results/phospho/final_samples/signaling_input_carnival.tsv")
...
names(metab_input_carnival) %in% meta_network_with_X$source | names(metab_input_carnival) %in% meta_network_with_X$target
