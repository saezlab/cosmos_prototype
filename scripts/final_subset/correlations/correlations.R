...
# write_csv(reduced_cor_net, "results/multi_omic/final_sample/correlation/reduced_cor_net.csv")
# write_csv(edge_df_to_write, "results/multi_omic/final_sample/correlation/cor_net.csv")
...
# write_csv(reduced_cor_net, "results/multi_omic/final_sample/correlation/reduced_cor_net_tumor.csv")
# write_csv(edge_df_to_write, "results/multi_omic/final_sample/correlation/cor_net_tumor.csv")
